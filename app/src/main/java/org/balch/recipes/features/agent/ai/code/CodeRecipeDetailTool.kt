...
class CodeRecipeDetailTool @Inject internal constructor(
    ...
    data class Args(
        @property:LLMDescription("The codeRecipe from the code_recipe_lookup and code_recipe_search tools.\n")
    ...
    override val description = """
        ...
        The input comes from the code_recipe_lookup and code_recipe_search tools.
    """.trimIndent()
